...
class LegacyActivityDataMigratorTest {
    ...
    @Test
    fun `isMigrationNeeded returns false when no legacy data`() = runTest {
        val needed = migrator.isMigrationNeeded()
        assertFalse(needed)
    }

    @Test
    fun `isMigrationNeeded returns false when already migrated`() = runTest {
    ...
    @Test
    fun `isMigrationNeeded returns true when legacy data exists`() = runTest {
        // Populate legacy data
        val prefs = context.getSharedPreferences("activity_data", Context.MODE_PRIVATE)
        prefs.edit()
            .putInt("chapters_2024-01-15", 10)
    ...
    @Test
    fun `migrate transfers all data correctly`() = runTest {
        val prefs = context.getSharedPreferences("activity_data", Context.MODE_PRIVATE)
    ...
    @Test
    fun `migrate skips empty records`() = runTest {
        val prefs = context.getSharedPreferences("activity_data", Context.MODE_PRIVATE)
    ...
    @Test
    fun `migrate handles partial data for a date`() = runTest {
        val prefs = context.getSharedPreferences("activity_data", Context.MODE_PRIVATE)
        val date = "2024-01-15"
    ...
    @Test
    fun `migrate sets completion flag`() = runTest {
        val prefs = context.getSharedPreferences("activity_data", Context.MODE_PRIVATE)
    ...
    @Test
    fun `migrate ignores invalid date formats`() = runTest {
        val prefs = context.getSharedPreferences("activity_data", Context.MODE_PRIVATE)
    ...
    @Test
    fun `clearLegacyData removes all legacy keys`() = runTest {
        val prefs = context.getSharedPreferences("activity_data", Context.MODE_PRIVATE)
    ...
    @Test
    fun `migrate handles large dataset efficiently`() = runTest {
        val prefs = context.getSharedPreferences("activity_data", Context.MODE_PRIVATE)
    ...
    @Test
    fun `second migration attempt is skipped`() = runTest {
        val prefs = context.getSharedPreferences("activity_data", Context.MODE_PRIVATE)
        prefs.edit()
            .putInt("chapters_2024-01-15", 10)
            .apply()
