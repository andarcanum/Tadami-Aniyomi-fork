...
data class NovelReaderSettings(
    ...
    val spreadCutoutGuard: Boolean = true,
...
class NovelReaderPreferences(
    ...
    fun spreadCutoutGuard() = preferenceStore.getBoolean("novel_reader_spread_cutout_guard", true)
    ...
    fun resolveSettings(sourceId: Long): NovelReaderSettings {
        ...
        return NovelReaderSettings(
            ...
            spreadCutoutGuard = spreadCutoutGuard().get(),
    ...
    fun settingsFlow(sourceId: Long): Flow<NovelReaderSettings> {
        ...
        return combine(
            ...
            NovelReaderSettings(
                ...
                spreadCutoutGuard = navigation.spreadCutoutGuard,
