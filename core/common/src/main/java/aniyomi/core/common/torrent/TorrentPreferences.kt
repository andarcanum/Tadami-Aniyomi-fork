...
class TorrentPreferences(
    ...
    fun torrServerTrackers() = preferenceStore.getString("pref_torrserver_trackers", DEFAULT_TRACKERS)
    ...
    companion object {
        val DEFAULT_TRACKERS: String = """http://nyaa.tracker.wf:7777/announce
